...
function crpTag_moduletagsblock_display($blockinfo)
{
	...
	$blockinfo['content'] = $render->fetch('blocks/crptag_block_moduletags_cloud.htm');
...
function crpTag_moduletagsblock_modify($blockinfo)
{
	...
	$modulesArray = array_keys(pnModAPIFunc('Modules', 'admin', 'gethookedmodules', array (
		'hookmodname' => 'crpTag'
	)));
	...
	$render->assign($vars);
	$render->assign('modulesArray', $modulesArray);

	// Return the output that has been generated by this function
	return $render->fetch('blocks/crptag_block_moduletags_cloud_modify.htm');
}
...
function crpTag_moduletagsblock_update($blockinfo)
{
	...
	$render->clear_cache('blocks/crptag_block_moduletags_cloud.htm');
